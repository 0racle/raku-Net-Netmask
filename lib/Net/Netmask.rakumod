...
is inspired by the Perl module of the same name.

Not all methods support IPv6 yet.  The IPv6 interface is subject to change and
should be considered experimental.

This module does not have full method parity with it's Perl cousin. Pull
...
class Net::Netmask:ver<0.2.1>:auth<zef:elcaro> {
    ...
    #based on http://rosettacode.org/wiki/Parse_an_IP_Address#Raku
    grammar IP_Addr {
